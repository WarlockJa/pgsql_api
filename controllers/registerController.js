...
const registerUser = async (req, res) => {
    ...
    try {
        ...
        await pool.execute("INSERT INTO users (email, name, password, email_confirmed, darkmode, locale, widgets) VALUES(?, ?, ?, ?, ?, ?, ?)", [email, name, hashedPassword, 0, darkmode, locale, widgets]);
